...
def parse_args():
    ...
    parser.add_argument('--kafka-dir', type=str, default='/', help='')
...
def main():
    ...
    logging.info(f'Model/execution descriptions {args}')
    ...
    for epoch in range(args.epochs):
        ...
        for input, label in data_loader:
            ...
            # perform randomized iid injection
            for _ in range(injected_classes):
                # get a label not in current workers' label-list
                ...
                samplesize1 = int(args.beta * loader_bsz)
            ...
            # in truncate mode, only keep data buffered in during current steps' fwd backward pass
